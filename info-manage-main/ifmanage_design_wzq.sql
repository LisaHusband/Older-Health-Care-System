/*
 ...
 Source Schema         : ifmanage_design_wzq
...
CREATE TABLE `accident_record`  (
  ...
  `accident` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事故',
  `desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '原因',
  `acc_time` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '年月',
  `loss` bigint(20) NULL DEFAULT NULL COMMENT '损失',
...
-- ----------------------------
INSERT INTO `accident_record` VALUES (1, '火灾', '某位老人在寝室抽烟，烟头点燃了被褥', '2004-06', 10);
...
CREATE TABLE `admin_info`  (
  ...
  `admin_login` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录名',
  `admin_pwd` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '123' COMMENT '密码',
  `admin_name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户名',
  `admin_tel` bigint(20) NULL DEFAULT 18380565975 COMMENT '电话',
  `admin_sex` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '男' COMMENT '性别',
  `power` smallint(6) NULL DEFAULT 1 COMMENT '权限',
...
CREATE TABLE `dormitory_allocation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `dormitory` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '宿舍',
  `living` smallint(6) NULL DEFAULT 0 COMMENT '0无人居住 1有人居住',
  `name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '---' COMMENT '老人姓名',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `go_out`  (
  ...
  `event` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '外出事件',
  `event_time` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日期',
  `back_time` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '归来时间',
  `name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `health_records`  (
  ...
  `sex` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '男' COMMENT '性别',
  `born` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '出生',
  ...
  `allergy` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '过敏',
  `heart_rate` double NULL DEFAULT NULL COMMENT '心率 60～100次/分',
  `blood_pressure` double NULL DEFAULT NULL COMMENT '血压 90～139mmHg',
  `blood_sugar` double NULL DEFAULT NULL COMMENT '血糖 3.92～7.0mmol/L',
  `smoke` varbinary(6) NULL DEFAULT '否' COMMENT '吸烟',
  `create_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `high_risk`  (
  ...
  `name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `tel` bigint(20) NULL DEFAULT NULL COMMENT '电话',
  `high_case` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病例',
  `relatives` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '亲属',
  `re_tel` bigint(20) NULL DEFAULT NULL COMMENT '亲属电话',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `medication`  (
  ...
  `medication` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '药名',
  `create_time` date NULL DEFAULT NULL COMMENT '生产时间',
  `expiration_time` date NULL DEFAULT NULL COMMENT '过期时间',
  `cost` double NULL DEFAULT NULL COMMENT '价格',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `monthly_catering`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `mon_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜肴',
  `cost` int(11) NULL DEFAULT NULL COMMENT '费用',
  `mon_time` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日期',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `older_info`  (
  ...
  `older_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `older_sex` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '男' COMMENT '性别',
  `older_tel` bigint(20) NOT NULL COMMENT '电话',
  `older_addr` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '住址',
  `older_idcard` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '身份证号码',
  `in_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '入住时间',
  `out_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '---' COMMENT '出院时间',
...
CREATE TABLE `root_info`  (
  ...
  `name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录名',
  ...
  `power` smallint(6) NULL DEFAULT 0 COMMENT '权限',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `usr_info`  (
  ...
  `usr_login` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '登录名',
  `usr_name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户名',
  `usr_sex` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '男' COMMENT '性别',
  `usr_pwd` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '123' COMMENT '登录密码',
  `usr_tel` bigint(20) NULL DEFAULT NULL COMMENT '电话',
  `older_name` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '家属',
  `usr_addr` varchar(22) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址',
  `admin_id` bigint(20) NULL DEFAULT NULL COMMENT '创建者id',
  `power` smallint(6) NULL DEFAULT 2 COMMENT '权限',
...
CREATE TABLE `visitor`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访客姓名',
  `target` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问对象',
  `vi_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
